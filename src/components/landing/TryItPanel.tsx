    ...
    >
      {jobId ? (
        ...
        <AnalyseForm
          ...
          description={
            user
              ? 'Paste a Rightmove property link and we will score it straight away.'
              : 'Paste a Rightmove property link. We will ask you to sign in or create an account just before the analysis runs, then show the result here.'
          }
